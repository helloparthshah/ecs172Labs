...
b.prototype.R=function(g){if(g===this)this.s(new TypeError("A Promise cannot resolve to itself"));else if(g instanceof b)this.da(g);else{a:switch(typeof g){case "object":var h=null!=g;break a;case "function":h=!0;break a;default:h=!1}h?this.M(g):this.o(g)}};
b.prototype.M=function(g){var h=void 0;try{h=g.then}catch(k){this.s(k);return}"function"==typeof h?this.la(h,g):this.o(g)};
...
c.prototype=b.prototype;a.Y=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.ap=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var Lc="undefined"!==typeof Uint8Array;var Mc={};var Nc="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function Oc(a,b){Object.isFrozen(a)||(Nc?a[Nc]|=b:void 0!==a.Ka?a.Ka|=b:Object.defineProperties(a,{Ka:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
...
;function We(a){Te.call(this);var b=this;this.B=this.l=0;this.T=null!=a?a:{N:function(e,f){return setTimeout(e,f)},
...
function Ye(a){a.B=a.T.N(function(){var b;return w(function(c){if(1==c.i)return a.j?(null==(b=window.navigator)?0:b.onLine)?c.u(3):t(c,Xe(a),3):t(c,Xe(a),3);Ye(a);c.i=0})},3E4)}
function Xe(a,b){return a.v?a.v:a.v=new Promise(function(c){var d,e,f,g;return w(function(h){switch(h.i){case 1:return d=window.AbortController?new window.AbortController:void 0,f=null==(e=d)?void 0:e.signal,g=!1,wa(h,2,3),d&&(a.l=a.T.N(function(){d.abort()},b||2E4)),t(h,fetch("/generate_204",{method:"HEAD",
...
;var af={Pg:"EMBEDDED_PLAYER_MODE_UNKNOWN",Mg:"EMBEDDED_PLAYER_MODE_DEFAULT",Og:"EMBEDDED_PLAYER_MODE_PFP",Ng:"EMBEDDED_PLAYER_MODE_PFL"},bf={Ko:"WEB_DISPLAY_MODE_UNKNOWN",Go:"WEB_DISPLAY_MODE_BROWSER",Io:"WEB_DISPLAY_MODE_MINIMAL_UI",Jo:"WEB_DISPLAY_MODE_STANDALONE",Ho:"WEB_DISPLAY_MODE_FULLSCREEN"};function cf(){this.data_=[];this.i=-1}
...
378,380,381,388,389,403,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117];var Ah={Kh:0,vh:1,Bh:2,Ch:4,Hh:8,Dh:16,Eh:32,Jh:64,Ih:128,xh:256,zh:512,Gh:1024,yh:2048,Ah:4096,wh:8192,Fh:16384};function Bh(a){I.call(this,a)}
r(Bh,I);function Ch(a){I.call(this,a)}
...
function wj(a,b,c){c=void 0===c?{}:c;var d={};M("enable_web_eom_visitor_data")&&L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Zo||L("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().Yo:b=me([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
Gj.prototype.N=function(a,b){return Ij(a,1,b)};
...
l.ya=function(){var a=this;if(!this.A)throw pk("throttleSend");this.j||(this.j=this.T.N(function(){var b;return w(function(c){if(1==c.i)return t(c,a.K.sb("NEW",a.A),2);if(3!=c.i)return b=c.j,b?t(c,zl(a,b),3):(a.jb(),c.return());a.j&&(a.j=0,a.ya());c.i=0})},this.Gb))};
...
!g&&a.potentialEsfErrorCounter>a.Oa)return m.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){m.u(8);break}return b.sendCount<a.Eb?t(m,a.K.fb(b.id,a.A),12):t(m,a.K.ma(b.id,a.A),8);case 12:a.T.N(function(){a.J.H()&&a.ya()},a.Db);
case 8:c(e,f),m.i=0}})};
...
function yl(a){if(!a.A)throw pk("retryQueuedRequests");a.K.sb("QUEUED",a.A).then(function(b){b&&!Bl(a,b,a.Ab)?a.T.N(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):t(c,a.K.fb(b.id,a.A),2);yl(a);c.i=0})}):a.J.H()&&a.ya()})}
...
return c}return this.v?this.v:this.v=new Promise(function(d){var e,f,g,h;return w(function(k){switch(k.i){case 1:return e=window.AbortController?new window.AbortController:void 0,g=null==(f=e)?void 0:f.signal,h=!1,wa(k,2,3),e&&(b.M=$e.N(function(){e.abort()},a||2E4)),t(k,fetch("/generate_204",{method:"HEAD",
signal:g}),5);case 5:h=!0;case 3:za(k);M("use_cfr_monitor")&&om().requestComplete("generate_204",h);b.v=void 0;b.M&&$e.S(b.M);h!==b.l&&(b.l=h,b.l&&b.o?Ue(b,"ytnetworkstatus-online"):b.o&&Ue(b,"ytnetworkstatus-offline"));d(h);Aa(k);break;case 2:ya(k),h=!1,k.u(3)}})})};
um.prototype.sendNetworkCheckRequest=um.prototype.ca;um.prototype.listen=um.prototype.U;um.prototype.enableErrorFlushing=um.prototype.Qb;um.prototype.getWindowStatus=um.prototype.Xa;um.prototype.monitorNetworkStatusChange=um.prototype.Yb;um.prototype.networkStatusHint=um.prototype.aa;um.prototype.isNetworkAvailable=um.prototype.H;um.getInstance=xm;function zm(a){a=void 0===a?{}:a;Te.call(this);var b=this;this.l=this.M=0;this.o="ytnetworkstatus-offline";this.v="ytnetworkstatus-online";M("use_shared_nsm")&&(this.o="networkstatus-offline",this.v="networkstatus-online");this.j=xm();var c=A("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.pb);a.xb&&(c=A("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=A("yt.networkStatusManager.instance.listen").bind(this.j))a.Qa?(this.Qa=a.Qa,c(this.v,
...
function Am(a,b){a.Qa?a.l?($e.S(a.M),a.M=$e.N(function(){a.B!==b&&(Ue(a,b),a.B=b,a.l=P())},a.Qa-(P()-a.l))):(Ue(a,b),a.B=b,a.l=P()):Ue(a,b)}
...
b=void 0===b?{}:b;M("skip_is_supported_killswitch")?kl().then(function(d){c(d)}):c(jl())}
function Rm(){var a=jl();if(!a)throw pk("throttleSend");Km||(Km=$e.N(function(){var b;return w(function(c){if(1==c.i)return t(c,Zl("NEW",a),2);if(3!=c.i)return b=c.j,b?t(c,Xm(b),3):(Sm(),c.return());Km&&(Km=0,Rm());c.i=0})},100))}
...
function Pm(){var a=jl();if(!a)throw pk("retryQueuedRequests");Zl("QUEUED",a).then(function(b){b&&!Zm(b,12E4)?$e.N(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):t(c,am(b.id,a),2);Pm();c.i=0})}):Qm().H()&&Rm()})}
...
;var pn=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function qn(a){this.L=a;this.j=null;this.o=0;this.B=null;this.v=0;this.l=[];for(a=0;4>a;a++)this.l.push(0);this.m=0;this.R=nn(window,"mousemove",Wa(this.W,this));a=Wa(this.M,this);"function"===typeof a&&(a=Th(a));this.da=window.setInterval(a,25)}
Ya(qn,J);qn.prototype.W=function(a){void 0===a.i&&jn(a);var b=a.i;void 0===a.j&&jn(a);this.j=new Hd(b,a.j)};
qn.prototype.M=function(){if(this.j){var a=pn();if(0!=this.o){var b=this.B,c=this.j,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.o);this.l[this.m]=.5<Math.abs((d-this.v)/this.v)?1:0;for(c=b=0;4>c;c++)b+=this.l[c]||0;3<=b&&this.L();this.v=d}this.o=a;this.B=this.j;this.m=(this.m+1)%4}};
...
function un(a,b){rn[a]||(rn[a]=!0,$e.N(function(){tn();rn[a]=!1},b))}
...
function So(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,yb:a,sa:b,bp:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
":"+Ca);if("IGNORED"===a.level)var ua=0;else a:{for(var Gn=fp(),Hn=q(Gn.fa),vi=Hn.next();!vi.done;vi=Hn.next()){var In=vi.value;if(G.message&&G.message.match(In.jp)){ua=In.weight;break a}}for(var Jn=q(Gn.ea),wi=Jn.next();!wi.done;wi=Jn.next()){var Kn=wi.value;if(Kn.ia(G)){ua=Kn.weight;break a}}ua=1}G.sampleWeight=ua;for(var Ln=q(ap),xi=Ln.next();!xi.done;xi=Ln.next()){var yi=xi.value;if(yi.Na[G.name])for(var Mn=q(yi.Na[G.name]),zi=Mn.next();!zi.done;zi=Mn.next()){var Nn=zi.value,Nf=G.message.match(Nn.regexp);
...
function Gp(a){a=q(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.mp("ABORTED")}
...
return a.join("")}
;var Kp=x.ytLoggingDocDocumentNonce_;Kp||(Kp=Jp(),z("ytLoggingDocDocumentNonce_",Kp));var Lp=Kp;var Mp={Bg:0,pd:1,zd:2,nk:3,Dg:4,yo:5,fl:6,Im:7,gm:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function Np(a){this.i=a}
...
ih:57205,jh:18198,kh:17898,lh:17909,mh:43980,nh:46220,oh:11721,ph:147994,qh:49954,rh:96369,sh:3854,th:56251,uh:25624,Lh:16906,Mh:99999,Nh:68172,Oh:27068,Ph:47973,Qh:72773,Rh:26970,Sh:26971,Th:96805,Uh:17752,Vh:73233,Wh:109512,Xh:22256,Yh:14115,Zh:22696,ai:89278,bi:89277,ci:109513,di:43278,fi:43459,gi:43464,hi:89279,ii:43717,ji:55764,ki:22255,li:147912,mi:89281,ni:40963,oi:43277,ri:43442,si:91824,ti:120137,vi:96367,wi:36850,xi:72694,yi:37414,zi:36851,Bi:124863,Ai:121343,Ci:73491,Di:54473,Ei:43375,
Fi:46674,Gi:143815,Hi:139095,Ii:144402,Ji:149968,Ki:149969,Li:32473,Mi:72901,Ni:72906,Oi:50947,Pi:50612,Qi:50613,Ri:50942,Si:84938,Ti:84943,Ui:84939,Vi:84941,Wi:84944,Xi:84940,Yi:84942,Zi:35585,aj:51926,bj:79983,cj:63238,dj:18921,ej:63241,fj:57893,gj:41182,hj:135732,ij:33424,jj:22207,kj:42993,lj:36229,mj:22206,nj:22205,oj:18993,pj:19001,qj:18990,rj:18991,sj:18997,tj:18725,uj:19003,vj:36874,wj:44763,xj:33427,yj:67793,zj:22182,Aj:37091,Bj:34650,Cj:50617,Dj:47261,Ej:22287,Fj:25144,Gj:97917,Hj:62397,
Ij:150871,Jj:150874,Kj:125598,Lj:137935,Mj:36961,Nj:108035,Oj:27426,Pj:27857,Qj:27846,Rj:27854,Sj:69692,Tj:61411,Uj:39299,Vj:38696,Wj:62520,Xj:36382,Yj:108701,Zj:50663,ak:36387,bk:14908,ck:37533,dk:105443,ek:61635,fk:62274,gk:133818,hk:65702,ik:65703,jk:65701,kk:76256,lk:37671,mk:49953,pk:36216,qk:28237,rk:39553,sk:29222,tk:26107,uk:38050,vk:26108,xk:120745,wk:26109,yk:26110,zk:66881,Ak:28236,Bk:14586,Ck:57929,Dk:74723,Ek:44098,Fk:44099,Ik:23528,Jk:61699,Gk:134104,Hk:134103,Kk:59149,Lk:101951,Mk:97346,
Nk:118051,Ok:95102,Pk:64882,Qk:119505,Rk:63595,Sk:63349,Tk:95101,Uk:75240,Vk:27039,Wk:68823,Xk:21537,Yk:83464,Zk:75707,al:83113,bl:101952,dl:101953,il:79610,jl:125755,kl:24402,ll:24400,ml:32925,nl:57173,ol:122502,pl:145268,ql:138480,rl:64423,sl:64424,ul:33986,vl:100828,wl:129089,xl:21409,Bl:135155,Cl:135156,Dl:135157,El:135158,Fl:135159,Gl:135160,Hl:135161,Il:135162,Jl:135163,Kl:135164,Ll:135165,Ml:135166,yl:11070,zl:11074,Al:17880,Nl:14001,Pl:30709,Ql:30707,Rl:30711,Sl:30710,Tl:30708,Ol:26984,Ul:146143,
Vl:63648,Wl:63649,Xl:51879,Yl:111059,Zl:5754,am:20445,cm:130975,bm:130976,dm:110386,em:113746,fm:66557,hm:17310,im:28631,jm:21589,km:68012,lm:60480,mm:138664,nm:141121,om:31571,pm:141978,qm:150105,rm:150106,sm:150107,tm:150108,um:76980,vm:41577,wm:45469,xm:38669,ym:13768,zm:13777,Am:141842,Bm:62985,Cm:4724,Dm:59369,Em:43927,Fm:43928,Gm:12924,Hm:100355,Km:56219,Lm:27669,Mm:10337,Jm:47896,Nm:122629,Pm:139723,Om:139722,Qm:121258,Rm:107598,Sm:127991,Tm:96639,Um:107536,Vm:130169,Wm:96661,Xm:145188,Ym:96658,
Zm:116646,an:121122,bn:96660,cn:127738,dn:127083,en:147842,fn:104443,gn:96659,hn:147595,jn:106442,kn:134840,ln:63667,mn:63668,nn:63669,pn:130686,qn:147036,rn:78314,sn:147799,tn:148649,un:55761,vn:127098,wn:134841,xn:96368,yn:67374,zn:48992,An:146176,Bn:49956,Cn:31961,Dn:26388,En:23811,Fn:5E4,Gn:126250,Hn:96370,In:47355,Jn:47356,Kn:37935,Ln:45521,Mn:21760,Nn:83769,On:49977,Pn:49974,Qn:93497,Rn:93498,Sn:34325,Tn:140759,Un:115803,Vn:123707,Wn:100081,Xn:35309,Yn:68314,Zn:25602,ao:100339,bo:143516,co:59018,
eo:18248,fo:50625,ho:9729,jo:37168,ko:37169,lo:21667,mo:16749,no:18635,oo:39305,po:18046,qo:53969,ro:8213,so:93926,to:102852,uo:110099,vo:22678,wo:69076,xo:137575,zo:139224,Ao:100856,Bo:17736,Co:3832,Do:147111,Eo:55759,Fo:64031,Lo:93044,Mo:93045,No:34388,Oo:17657,Po:17655,Qo:39579,Ro:39578,So:77448,To:8196,Uo:11357,Vo:69877,Wo:8197,Xo:82039};function aq(){var a=ub(bq),b;return ag(new Uf(function(c,d){a.onSuccess=function(e){mi(e)?c(new cq(e)):d(new dq("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
try{bt("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}jt.push($e.N(function(){if(!(kt||"google_ad_status"in window)){try{ht("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}kt=!0;Lh("DCLKSTAT",3)}},5E3))}}
...
;function Lt(a,b,c){J.call(this);var d=this;c=c||L("POST_MESSAGE_ORIGIN")||window.document.location.protocol+"//"+window.document.location.hostname;this.l=b||null;this.L="*";this.m=c;this.sessionId=null;this.channel="widget";this.M=!!a;this.B=function(e){a:if(!("*"!=d.m&&e.origin!=d.m||d.l&&e.source!=d.l||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.M&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
e.origin&&(d.m=d.L=e.origin);d.l=e.source;d.sessionId=f.id;d.j&&(d.j(),d.j=null);break;case "command":d.o&&(!d.v||0<=db(d.v,f.func))&&d.o(f.func,f.args,e.origin)}}};
this.v=this.j=this.o=null;window.addEventListener("message",this.B)}
r(Lt,J);Lt.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.L)}catch(d){Vh(d)}}};
...
r(hu,J);l=hu.prototype;l.getId=function(){return this.M};
...
function ku(a){var b;a.webPlayerContextConfig?b=a.webPlayerContextConfig.rootElementId:b=a.config.attrs.id;a.elementId=b||a.elementId;"video-player"===a.elementId&&(a.elementId=a.M,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.M:a.config.attrs.id=a.M);var c;(null==(c=a.l)?void 0:c.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
...
function zu(a,b){var c="ytPlayer"+b+a.M;a.j[b]=c;x[c]=function(d){var e=ni(function(){if(!a.i()){a.R.ha(b,null!=d?d:void 0);var f=a.L,g=String(e);g in f&&delete f[g]}},0);
pb(a.L,String(e))};
return c}
...
nt();M("ytidb_create_logger_embed_killswitch")||Uj();a={};Gt||(Gt=new Ft);Gt.install((a.flush_logs={ia:function(){Jo()}},a));
M("networkless_logging_web_embedded")&&(M("embeds_web_enable_new_nwl")?Gm():Om());M("ytidb_clear_embedded_player")&&$e.N(function(){var e;if(!us){Aq||(Aq=new xq);var f=Aq;var g={dc:ts,Hb:ss};f.providers.set(g.dc,g);g={lb:{feedbackEndpoint:Lq(os),modifyChannelNotificationPreferenceEndpoint:Lq(ps),playlistEditEndpoint:Lq(qs),subscribeEndpoint:Lq(ms),unsubscribeEndpoint:Lq(ns),webPlayerShareEntityServiceEndpoint:Lq(rs)}};var h=M("web_enable_client_location_service")?Hq.getInstance():void 0,k={};h&&(k.client_location=
